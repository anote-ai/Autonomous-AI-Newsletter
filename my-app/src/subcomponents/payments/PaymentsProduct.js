...
//         <h6>Subscribe</h6>
//         <p>If tab doesn't open, click to proceed to payments</p>
//         <button class={"ButtonType1"} onClick={()=>{
//           window.open(stripeUrl, "_blank");
//         }}>Proceed</button>
//         <Link to={accountPath} >Back to Pricing</Link>
//     </div>
//   );
// };
...
const PaymentsProduct = () => {
  ...
  return (
    <div className="bg-gray-800 p-8 rounded-md shadow-lg w-96 mx-auto mt-20 text-white">
        ...
        <Link to={accountPath} className="bg-cyan-700 w-full py-2 rounded-md text-center block hover:bg-gray-600 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-200 active:bg-gray-800">Back to Pricing</Link>
    </div>
  );
};
