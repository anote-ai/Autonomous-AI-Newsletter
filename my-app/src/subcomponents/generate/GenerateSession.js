...
import { setTopic, useData, useTopic, setNewsletter, setData } from "../../redux/newsLetterSlice"
    ...
    async function getNextStep() {
        if (pageState == pageTotal) {
            try {
                ...
                let returnBack = await dispatch(setNewsletter({ firstPageData: firstPageData, data: letterData}));
